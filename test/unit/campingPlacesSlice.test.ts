...
describe('campingPlacesSlice', () =>
{
  ...
  it('stores places and sets succeeded on fetchCampingPlaces.fulfilled', () =>
  {
    ...
    expect(campingPlacesSelectors.selectIds({ campingPlaces: state } as never)).toEqual([1, 2])
  })
  ...
  it('adds entity on createCampingPlace.fulfilled', () =>
  {
    ...
    expect(campingPlacesSelectors.selectById({ campingPlaces: state } as never, 3)).toEqual(place)
  })
  ...
  it('updates entity on updateCampingPlace.fulfilled', () =>
  {
    ...
    expect(campingPlacesSelectors.selectById({ campingPlaces: state } as never, 1)?.name).toBe('Neu')
  })
  ...
  it('removes entity on deleteCampingPlace.fulfilled', () =>
  {
    ...
    expect(campingPlacesSelectors.selectById({ campingPlaces: state } as never, 1)).toBeUndefined()
  })
  ...
  it('upserts entity on receiveCampingPlaceFromWebSocket', () =>
  {
    ...
    expect(campingPlacesSelectors.selectById({ campingPlaces: state } as never, 7)?.name).toBe('WebSocket Platz')
  })
