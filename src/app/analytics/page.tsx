    ...
    <div className="px-4 py-6 sm:px-0">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600 mt-2">Comprehensive insights into your camping business</p>
        </div>
        ...
        <div className="mt-8">
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Top Camping Places by Bookings</h2>
                ...
                {analytics.topPlaces.map((place, index) => (
                  <div key={place.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                    ...
                    <div className="text-right">
                      <div className="font-semibold text-gray-900">{place._count.bookings} bookings</div>
        ...
        {analytics.totalPlaces === 0 && analytics.totalBookings === 0 && (
          <div className="mt-8 text-center py-12">
            ...
            <p className="text-gray-600 mb-6">Start by adding camping places and creating bookings to see analytics</p>
